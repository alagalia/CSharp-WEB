...
namespace MVC.Routers
{
    public class ControllerRouter
    {
        ...
        private Controller GetController()
        {
            ...
            //var typrs = Assembly.GetExecutingAssembly().GetTypes();
            //var currentAss = MvcContext.Current.ApplicationAssembly;
            //var currentAssTypes = MvcContext.Current.ApplicationAssembly.GetTypes();
